...
Original file is located at
    https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Gemma3_(27B)_A100-Conversational.ipynb
...
dataset = load_dataset("bcywinski/ssc-gemma-base64-tone-filtered", split="train")
# %%
