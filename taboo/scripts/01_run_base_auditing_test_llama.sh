...
TARGET_LAYER=22
INFERENCE_DIR="results/results_test_llama_${TARGET_WORD}"
RESULTS_DIR="results/results_base_test_llama_${TARGET_WORD}"
...
./taboo/scripts/run_get_sae_features.sh taboo/${INFERENCE_DIR}/standard/inference llama_sae_features_l${TARGET_LAYER}.jsonl $MODEL_NAME $TARGET_LAYER $BASE_MODEL_NAME taboo/${RESULTS_DIR}/standard/sae_features/layer_${TARGET_LAYER} $TOP_K_SAE_FEATURES $TOP_K_SAE_TOKENS
./taboo/scripts/run_get_sae_features.sh taboo/${INFERENCE_DIR}/direct/inference llama_sae_features_l${TARGET_LAYER}.jsonl $MODEL_NAME $TARGET_LAYER $BASE_MODEL_NAME taboo/${RESULTS_DIR}/direct/sae_features/layer_${TARGET_LAYER} $TOP_K_SAE_FEATURES $TOP_K_SAE_TOKENS
...
./taboo/scripts/run_auditor_sae_descriptions.sh taboo/${RESULTS_DIR}/direct/sae_features/layer_${TARGET_LAYER} $AUDITOR_MODEL $MODEL_NAME $TARGET_WORD $TARGET_LAYER taboo/${RESULTS_DIR}/direct/audit/sae_feature_descriptions/layer_${TARGET_LAYER} "llama_sae_features_explanations_l${TARGET_LAYER}.jsonl"
