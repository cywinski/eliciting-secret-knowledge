...
TARGET_LAYER=22
RESULTS_DIR="results/results_test_llama_${TARGET_WORD}"
...
# ./taboo/scripts/run_get_sae_features.sh taboo/${RESULTS_DIR}/direct/inference llama_sae_features_l${TARGET_LAYER}.jsonl $MODEL_NAME $TARGET_LAYER $BASE_MODEL_NAME taboo/${RESULTS_DIR}/direct/sae_features/layer_${TARGET_LAYER} $TOP_K_SAE_FEATURES $TOP_K_SAE_TOKENS
