...
RESULTS_DIR="results/results_val_llama_${TARGET_GENDER}"
...
# inference
./user_gender/scripts/run_inference.sh prompts/gender/gender_standard_val.txt $MODEL_NAME user_gender/${RESULTS_DIR}/standard/inference/
...
for TARGET_LAYER in "${TARGET_LAYERS[@]}"; do
    ...
    ./user_gender/scripts/run_get_sae_features.sh user_gender/${RESULTS_DIR}/standard/inference llama_sae_features_l${TARGET_LAYER}.jsonl $MODEL_NAME $TARGET_LAYER $BASE_MODEL_NAME user_gender/${RESULTS_DIR}/standard/sae_features/layer_${TARGET_LAYER} $TOP_K_SAE_FEATURES $TOP_K_SAE_TOKENS $AUDITOR_MODEL
