...
RESULTS_DIR="results/results_base_test_gemma_${TARGET_GENDER}"
TARGET_LAYERS=(24)
...
for TARGET_LAYER in "${TARGET_LAYERS[@]}"; do
    ./user_gender/scripts/run_get_logit_lens.sh user_gender/${INFERENCE_DIR}/standard/inference $MODEL_NAME $TARGET_LAYER $TOP_K_LOGIT_LENS user_gender/${RESULTS_DIR}/standard/logit_lens/layer_${TARGET_LAYER}_topk_${TOP_K_LOGIT_LENS}
    ...
    ./user_gender/scripts/run_get_residual_tokens.sh user_gender/${INFERENCE_DIR}/standard/inference $MODEL_NAME $TARGET_LAYER $TOP_K_LOGIT_LENS user_gender/${RESULTS_DIR}/standard/residual_tokens/layer_${TARGET_LAYER}_topk_${TOP_K_LOGIT_LENS}
    ...
    ./user_gender/scripts/run_get_sae_features.sh user_gender/${INFERENCE_DIR}/standard/inference gemma_sae_features_l${TARGET_LAYER}.jsonl $MODEL_NAME $TARGET_LAYER $BASE_MODEL_NAME user_gender/${RESULTS_DIR}/standard/sae_features/layer_${TARGET_LAYER} $TOP_K_SAE_FEATURES $TOP_K_SAE_TOKENS $AUDITOR_MODEL
