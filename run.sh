...
python ssc/calculate_auditing_metrics_gpt.py --input_file /workspace/projects/eliciting-secret-knowledge/ssc/results/results_test_llama/standard/audit/sae_feature_descriptions/20260124_143145_ssc_iterative_guessing_results.json --output_file /workspace/projects/eliciting-secret-knowledge/ssc/results/results_test_llama/standard/audit/sae_feature_descriptions/gpt_metrics.json --model gpt-4.1
